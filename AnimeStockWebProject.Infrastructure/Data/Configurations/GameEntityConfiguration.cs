    ...
    public class GameEntityConfiguration : IEntityTypeConfiguration<Game>
    {
        ...
        private ICollection<Game> CreateGames()
        {
            ...
            Game gameOne = new Game()
            {
                ...
                ReleaseDate = DateTime.ParseExact("January 26, 2021", EntityValidations.BookEntity.ReleaseDate, CultureInfo.InvariantCulture).Date,
            ...
            Game gameTwo = new Game()
            {
                ...
                ReleaseDate = DateTime.ParseExact("September 09, 2016", EntityValidations.BookEntity.ReleaseDate, CultureInfo.InvariantCulture).Date,
                PrintType = PrintTypeEnum.Digital,
                Price = 26.99m,
                platformType = PlatformTypeEnum.PC,
            };
            Game gameThree = new Game()
            {
                ...
                ReleaseDate = DateTime.ParseExact("March 01, 2021", EntityValidations.BookEntity.ReleaseDate, CultureInfo.InvariantCulture).Date,
            ...
            Game gameFour = new Game()
            {
                ...
                ReleaseDate = DateTime.ParseExact("November 02, 2022", EntityValidations.BookEntity.ReleaseDate, CultureInfo.InvariantCulture).Date,
                PrintType = PrintTypeEnum.Phisycal,
                Price = 34.00m,
